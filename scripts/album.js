...
var togglePlayFromPlayerBar = function() {
  ...
  if($('.main-controls .play-pause').html() == playerBarPauseButton) {
  ...
  else if($('.main-controls .play-pause').html() == playerBarPlayButton) {
    currentSoundFile.play();
    $('.main-controls .play-pause').html(playerBarPauseButton);
    ...
    setSong(1);
    currentSoundFile.play();
    var $nullSongNumberCell = getSongNumberCell(currentlyPlayingSongNumber);
    updatePlayerBarSong();
    $('.main-controls .play-pause').html(playerBarPauseButton);
    $nullSongNumberCell.html(pauseButtonTemplate);
  }
}
